...
static bool test() {
    ...
    OK(Tests::evalLua("hl.plugin.test.add_layer_rule()"));
    OK(getFromSocket("/reload"));

    OK(Tests::evalLua("hl.layer_rule({ match = { namespace = \"rule-layer\" }, plugin_rule = \"effect\" })"));
    ...
    OK(Tests::evalLua("hl.plugin.test.check_layer_rule()"));
