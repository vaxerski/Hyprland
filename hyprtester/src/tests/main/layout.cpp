...
static void testPosPreserve() {
    ...
    OK(Tests::dispatchLua("hl.dsp.window.resize({ window = \"class:kitty\", x = 1337, y = 69 })"));
    OK(Tests::dispatchLua("hl.dsp.window.move({ window = \"class:kitty\", x = 420, y = 420 })"));
...
static bool testFocusMRUAfterClose() {
    ...
    OK(Tests::dispatchLua("hl.dsp.focus({ window = \"class:kitty_A\" })"));
    OK(Tests::dispatchLua("hl.dsp.focus({ window = \"class:kitty_B\" })"));
    OK(Tests::dispatchLua("hl.dsp.focus({ window = \"class:kitty_C\" })"));

    OK(Tests::dispatchLua("hl.dsp.window.close()"));
...
static bool test() {
    ...
    // setup
    OK(Tests::dispatchLua("hl.dsp.focus({ workspace = 10 })"));
