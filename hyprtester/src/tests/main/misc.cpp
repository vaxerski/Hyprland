...
static std::string setFullscreenMode(const std::string& mode, const std::string& action = "toggle") {
    return Tests::dispatchLua("hl.dsp.window.fullscreen({ mode = " + Tests::luaQuote(mode) + ", action = " + Tests::luaQuote(action) + " })");
}

static std::string setFullscreenState(const int internal, const int client) {
    return Tests::dispatchLua("hl.dsp.window.fullscreen_state({ internal = " + std::to_string(internal) + ", client = " + std::to_string(client) + " })");
}

static std::string toggleFullscreenState(const int internal, const int client) {
    return Tests::dispatchLua("hl.dsp.window.fullscreen_state({ internal = " + std::to_string(internal) + ", client = " + std::to_string(client) + ", action = \"toggle\" })");
}
...
static bool test() {
    ...
    OK(Tests::dispatchLua("hl.dsp.workspace.toggle_special(\"test\")"));
